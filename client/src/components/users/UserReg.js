...
function UserReg() {
    ...
    const onSubmit = async (e) => {
        ...
        await axios.post(`http://${host.ip}:3001/auth/register`, data).then((response) => {
        ...
        <div className="container">
            <div className="row justify-content-center">
                <div className="col col-md-4 bg-white mt-5 p-4 rounded border border-dark d-flex flex-column justify-content-center">
                    ...
                    <h4 className = "text-center">Laboratory Information System Register</h4>
                    ...
                    {msg && <div className='alert alert-danger text-center p-1 mb-1'>{msg}</div>}
                        ...
                        <br></br>
                        <div>
                        <NavLink to="/register">Already User? ?</NavLink>
                        </div>
                    </form>
